...
contract FlashLoanArbitrage is FlashLoanSimpleReceiverBase {
    ...
    IERC20 private dai;
    IERC20 private usdc;
    IDexAggregator private dexContract;
    ...
    constructor(
        ...
        dexContract = IDexAggregator(dexContractAddress);
    }
    ...
    function executeOperation(
        ...
        // Buy Dai low at Dex 1
        dexContract.depositUSDC(1000000000); // 1000 USDC
        dexContract.buyDAI();

        // Sell Dai high at Dex 2
        dexContract.depositDAI(dai.balanceOf(address(this)));
        dexContract.sellDAI();

        // At the end of your logic above, this contract owes
        // the flash-loaned amount + premiums.
